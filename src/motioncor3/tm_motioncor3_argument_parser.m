function param_str = tm_motioncor3_argument_parser(param)
%% tm_motioncor3_argument_parser
% An argument parser to set the default arguments for MotionCor3. It also
