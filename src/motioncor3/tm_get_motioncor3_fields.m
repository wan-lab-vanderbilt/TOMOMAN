function mc3_fields = tm_get_motioncor3_fields()
%% tm_get_motioncor3_fields
...
mc3_fields = {'force_realign', 'boo', false;...         % Force realignment
              ...
              'TiffOrder', 'str', '';...                % This setting reads EER tiff file from last frame to the first frame (backward). The default is 1 and reads forward.
              'SplitSum', 'boo', false;...              % Write odd/even stacks for noise2noise training. 1 = true, 0 = false(default)
              'CTF_est', 'boo', true;...                % Estimate CTF. 1 = true, 0 = false
              'Cs', 'num', 2.7;...                      % Spherical abberration 
              'AmpCont', 'num', 0.07;...                % Amplitude contrast
              'ExtPhase', 'num', 0; ...                 % Controls whether an extra phase shift is estimated
              };
