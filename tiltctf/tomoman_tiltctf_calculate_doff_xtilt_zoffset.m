function d_off = tomoman_tiltctf_calculate_doff_xtilt_zoffset(grid,tiltangle,xtiltangle,pixelsize,zoffset)
...
% implementation)
d_off_will = (grid(1,:)'*(pixelsize/10000)).*tand(tiltangle);

error('__UNDER_CONSTRUCTION__');
%% calculate
