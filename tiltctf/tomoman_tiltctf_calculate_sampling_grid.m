function [grid_points,d_offsets] = tomoman_tiltctf_calculate_sampling_grid(image_size, pixelsize, ps_size, def_tol, xf, tilts,xaxistilt)
...
for i = 1:n_tilts
    ...
    def = tomoman_tiltctf_calculate_doff_xtilt(grid,tilts(i),xaxistilt,pixelsize);
