function filt_img = tomoman_function_dose_filter_frame_stack(input_stack, pixelsize, initial_dose, dose_per_frame, a, b, c)
...
for i = 1:z
    ...
    disp(['TOMOMAN: Frame ',num2str(i),' of ',num2str(z),' filtered...']);
end
