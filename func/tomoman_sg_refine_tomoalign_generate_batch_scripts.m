function tomoman_sg_refine_tomoalign_generate_batch_scripts(t,p,root_dir,script_name)
...
%                 % Write lines
%                 if c == 0   
%                     fprintf(bscript,['jid1=$(sbatch ',t(j).stack_dir,'/sg_refine_tomoalign/run_tomoalign.sh)','\n']);
%                 else
%                     fprintf(bscript,['sbatch --dependency=afterany:$jid1 ',t(j).stack_dir,'/sg_refine_tomoalign/run_tomoaligns.sh','\n']);
%                 end
%                 c = c + 1;
%             end
...
% 
%                 % Write lines                    
%                 fprintf(bscript,[t(j).stack_dir,'sg_refine_tomoalign/run_tomoalign.sh','\n']);
%             end
%             
%         case 'p.hpcl67'
%             for j = job_array(i,2):job_array(i,3)
...
%                 % Write lines
%                 if c == 0   
%                     fprintf(bscript,['sbatch ',t(j).stack_dir,'sg_refine_tomoalign/run_tomoalign.sh','\n']);
%                 else
%                     fprintf(bscript,['sbatch ',t(j).stack_dir,'sg_refine_tomoalign/run_tomoalign.sh','\n']);
%                 end
%                 c = c + 1;
