function tomoman_novactf_generate_batch_scripts(t,p,root_dir,script_name)
...
%                 % Write lines
%                 if c == 0   
%                     fprintf(bscript,['qsub -N job',num2str(i,'%02d'),num2str(c,'%02d'),' ',t(j).stack_dir,'novactf/run_novaCTF.sh','\n']);
%                 else
%                     fprintf(bscript,['qsub -N job',num2str(i,'%02d'),num2str(c,'%02d'),' -hold_jid job',num2str(i,'%02d'),num2str(c-1,'%02d'),' ',t(j).stack_dir,'novactf/run_novaCTF.sh','\n']);
%                 end
%                 c = c + 1;
%             end
        case 'p.192g'
