function tomoman_sg_refine_batchprocess_generate_tomogram_runscript(t,p)
...
% Open run script
rscript = fopen([t.stack_dir,'/sg_refine_batchprocess/run_IMOD.sh'],'w');
...
switch p.queue
    case 'p.hpcl67'
        fprintf(rscript,['#!/bin/bash -l\n',...
            ...
            '#SBATCH -e ' ,t.stack_dir,'/sg_refine_batchprocess/error_sg_refine_batchprocess\n',...
            '#SBATCH -o ' ,t.stack_dir,'/sg_refine_batchprocess/log_sg_refine_batchprocess\n',...
...
%             'source ~/.bashrc\n\n',]);                      % Get proper envionment; i.e. modules        
    ...
    otherwise
        error('only "local", "p.hpcl67" and "p.hpcl8" are supported for p.queue!!!!')
...
%     fprintf(rscript,['srun ',t.stack_dir,'/sg_refine_batchprocess/stack_process.sh\n\n']);
    fprintf(rscript,[t.stack_dir,'/sg_refine_batchprocess/stack_process.sh\n\n']);
...
for i = 1:numel(p.tomo_bin)
    ...
    fprintf(rscript,[p.fcrop_vol,' ',...
                     ...
                     '> ',t.stack_dir,'/sg_refine_batchprocess/binning_log.txt 2>&1','\n\n']);
...
fclose(rscript);
system(['chmod +x ',t.stack_dir,'/sg_refine_batchprocess/run_IMOD.sh']);
